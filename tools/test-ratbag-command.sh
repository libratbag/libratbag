...
cmds[6]="dpi get"
cmds[7]="dpi set 800"
cmds[8]="profile 0 resolution active get"
cmds[9]="profile 0 resolution active set 0"
cmds[10]="resolution 0 dpi get"
cmds[11]="resolution 0 dpi set 800"
cmds[12]="resolution 0 dpi get"
cmds[13]="profile 0 resolution 0 dpi get"
cmds[14]="profile 0 resolution 0 dpi set 800"
